...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.username_filed'
        db.add_column(u'xtreme_server_project', 'username_filed',
                      self.gf('django.db.models.fields.TextField')(default='Not Set'),
                      keep_default=False)

        # Adding field 'Project.password_field'
        db.add_column(u'xtreme_server_project', 'password_field',
                      self.gf('django.db.models.fields.TextField')(default='Not Set'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'xtreme_server_project', 'username_filed')

        # Deleting field 'Project.password_field'
        db.delete_column(u'xtreme_server_project', 'password_field')
    ...
    models = {
        ...
        u'xtreme_server.project': {
            ...
            'username_filed': ('django.db.models.fields.TextField', [], {'default': "'Not Set'"})
        },
