...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.username_field'
        db.add_column(u'xtreme_server_project', 'username_field',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.username_field'
        db.delete_column(u'xtreme_server_project', 'username_field')
