...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.queueName'
        db.add_column(u'xtreme_server_project', 'queueName',
                      self.gf('django.db.models.fields.TextField')(default='-1'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.queueName'
        db.delete_column(u'xtreme_server_project', 'queueName')
